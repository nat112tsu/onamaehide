      ...
      >
        ...
        <div className="space-y-5 overflow-y-auto p-5 pt-4 text-sm leading-relaxed text-ink">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>
                画面下のバーで「🖐 うごかす」「▭ なまえ」「⬤ アイコン」の3つを切り替えます。
                初期状態は「うごかす」です（画像を見ている最中に誤ってマスクを置かないため）。
              </li>
              <li>
                「🖐 うごかす」では、画像内を指やマウスのドラッグでスクロールできます。
                2本指でひろげる（PCではトラックパッドのピンチ）と拡大できます。
              </li>
              <li>
                「▭ なまえ」でタップすると、登録した名前の文字数に応じた大きさの四角を置きます。
                ドラッグすれば好きな大きさで置けます。
              </li>
              <li>
                「⬤ アイコン」でタップすると、その位置に丸いマスクを置きます
                （アイコンなど丸い部分を隠すのに便利です）。
              </li>
              <li>
                置いたマスクを選ぶと、すぐ上に「えらんだマスク」の操作列が出ます。
                −／＋で大きさを変え、「削除」で消せます。ドラッグで移動、角をドラッグでも
                大きさを変えられます。
              </li>
              <li>「↩︎ もどす」で直前の操作を取り消せます。</li>
            </ul>
          </section>
